...
import { COLUMN_MAX_WIDTH, LANDSCAPE_MAX_WIDTH, topPad, useLayout } from '../layout';

export default function DrillsTab() {
  const { insets, wide, landscape } = useLayout();
  ...
  return (
    ...
    <View style={[styles.root, wide && !landscape && styles.rootWide, wide && landscape && styles.rootLand]}>
...
const styles = StyleSheet.create({
  ...
  rootLand: { width: '100%', maxWidth: LANDSCAPE_MAX_WIDTH, alignSelf: 'center' },
